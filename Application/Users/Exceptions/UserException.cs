...
public class UserRoleNotFoundException(string role) :
    UserException(UserId.Empty(), $"Role under name: {role} not found");

public class UserInvalidCredentialsException() : UserException(UserId.Empty(), "Invalid credentials");
